 ...
 * @param bufferwidth - A buffer szélessége
 * @param bufferheight - A buffer magassága
 * @param buffer - Maga a buffer, egy kétdimenziós vektor tömb, 
 * !               ami izárólag karaktereket tartalmaz,
 *                 ezért többjegyű számokat  nem feltétlen lehet kiírni vele, 
 *                 de nem is az a cél
 */
class OutputBuffer{
